...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MyModel.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\MyModel\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MyModel.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MyModel\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MyModel\Author) { // it's a model object
