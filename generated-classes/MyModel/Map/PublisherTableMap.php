...
use MyModel\Publisher;
use MyModel\PublisherQuery;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MyModel.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\MyModel\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MyModel.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MyModel\\Publisher');
    ...
    {
        $this->addRelation('Book', '\\MyModel\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MyModel\Publisher) { // it's a model object
