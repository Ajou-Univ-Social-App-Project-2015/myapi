...
namespace MyModel\Map;

use MyModel\Book;
use MyModel\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'MyModel.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\MyModel\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'MyModel.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\MyModel\\Book');
        $this->setPackage('MyModel');
    ...
    {
        $this->addRelation('Publisher', '\\MyModel\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\MyModel\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \MyModel\Book) { // it's a model object
