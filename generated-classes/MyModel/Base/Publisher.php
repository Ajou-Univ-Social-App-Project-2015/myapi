...
use MyModel\Publisher as ChildPublisher;
use MyModel\PublisherQuery as ChildPublisherQuery;
use MyModel\Map\PublisherTableMap;
 ...
 *
 *
* @package    propel.generator.MyModel.Base
*/
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MyModel\\Map\\PublisherTableMap';
    ...
    /**
     * Initializes internal state of MyModel\Base\Publisher object.
     */
     ...
     * @return $this|\MyModel\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MyModel\\Publisher'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MyModel\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MyModel\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MyModel\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\MyModel\Book');
    }
