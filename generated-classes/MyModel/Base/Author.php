...
use \Exception;
use \PDO;
use MyModel\Author as ChildAuthor;
use MyModel\AuthorQuery as ChildAuthorQuery;
use MyModel\Book as ChildBook;
use MyModel\BookQuery as ChildBookQuery;
use MyModel\Map\AuthorTableMap;
...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\MyModel\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of MyModel\Base\Author object.
     */
     ...
     * @return $this|\MyModel\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\MyModel\\Author'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\MyModel\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MyModel\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MyModel\Author Clone of current object.
     * @throws PropelException
     */
